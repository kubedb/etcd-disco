---
title: Lector Cluster Create
menu:
  product_pharmer_0.1.0-alpha.1:
    identifier: lector-cluster-create
    name: Lector Cluster Create
    parent: reference
product_name: pharmer
menu_name: product_pharmer_0.1.0-alpha.1
section_menu_id: reference
---
## lector cluster create
...
```
lector cluster create [flags]
```

### Examples

```
lector cluster create <name>
```
