---
title: Lector Cluster Snapshot
menu:
  product_pharmer_0.1.0-alpha.1:
    identifier: lector-cluster-snapshot
    name: Lector Cluster Snapshot
    parent: reference
product_name: pharmer
menu_name: product_pharmer_0.1.0-alpha.1
section_menu_id: reference
---
## lector cluster snapshot

Store etcd cluster snapshot
...
```
lector cluster snapshot [flags]
```

### Examples

```
lector cluster snapshot <name>
```
