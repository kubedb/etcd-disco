...
func NewEtcdServerJoinConfig() *EtcdServerJoinConfig {
	return &EtcdServerJoinConfig{
		...
		ClientUrls: []string{embed.DefaultListenClientURLs},

		AdvertisePeerUrls:   []string{embed.DefaultInitialAdvertisePeerURLs},
		AdvertiseClientUrls: []string{embed.DefaultAdvertiseClientURLs},
		MetricUrls:          []string{},*/
...
func (cfg *EtcdServerJoinConfig) AddFlags(fs *pflag.FlagSet) {
	...
	fs.StringVar(&cfg.ServerAddress, "server-address", "", "List of URLs to listen on for peer traffic.")

	//fs.StringArrayVar(&cfg.PeerUrls, "listen-peer-urls", cfg.PeerUrls, "List of URLs to listen on for peer traffic.")
	...
	//fs.StringArrayVar(&cfg.AdvertisePeerUrls, "initial-advertise-peer-urls", cfg.AdvertisePeerUrls, "List of this member's peer URLs to advertise to the rest of the cluster.")
	//fs.StringArrayVar(&cfg.AdvertiseClientUrls, "advertise-client-urls", cfg.AdvertiseClientUrls, "List of this member's client URLs to advertise to the public.")
...
func (cfg *EtcdServerJoinConfig) ValidateFlags(cmd *cobra.Command, args []string) error {
...
func (cfg *EtcdServerJoinConfig) EtcdServerConfig() etcd.ServerConfig {
